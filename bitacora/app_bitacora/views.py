...
def register_planta(request):
    # Filtramos solo los experimentos del usuario actual
    ...
    if request.method == "POST":
        ...
        # Creamos el nuevo registro asociado al experimento
    ...
    # Filtramos los registros de los experimentos del usuario actual
    registros = (
